...
<h3 align="center">Here is the List of Active competitions</h3>
 <table><caption>Active Competitions</caption><thead><tr><th scope="col">Id</th><th scope="col">Name</th><th scope="col">Start_Date</th><th scope="col">End_Date</th></tr></thead>
...
$query23="select * from active_competitions" ;
$op=mysql_query($query23);
if(!$op)
	echo "error";
$flag=0;
while($rf=mysql_fetch_array($op))
	{
		if($flag==0)
			{
		echo "<tr> <td>".$rf['id']."</td><td><a href=home.php?section=".$rf['id'].">".$rf['name']."</a></td><td>".$rf['start_date']."</td> <td>".$rf['end_date']."</td></tr>";	
	$flag=1;
	}
	else $flag=0;
	}
