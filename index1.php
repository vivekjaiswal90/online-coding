...
<div id="m5" 
    ...
    <? if ( isset($_SESSION['login']) && $_SESSION['login']==1 || 1)
			{
	?>
     <li><a href="#" 
        ...
        <div id="m7" 
            onmouseover="mcancelclosetime()" 
            onmouseout="mclosetime()">
      <a href="Change_Account_Information.php">Edit Account Information</a>
      <a href="Change_Account_Picture.php">Change Account Picture</a>
      <a href="Change_Passowrd.php">Change Password</a>
      <a href="View_scorecard">View ScoreCard</a>
        </div>
