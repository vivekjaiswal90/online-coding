...
<table><caption>My Score</caption><thead><tr><th scope="col">Id</th><th scope="col">Username</th><th scope="col">Problems Solved</th><th scope="col">Score</th><th scope="col">Total Submissions</th><th scope="col">Correct Submissions</th></thead>
<?
$username=$_SESSION['username'];
$query1="select * from user_solved where username='$username'";
$re1=mysql_query($query1);
$row=mysql_fetch_array($re1);
echo "<tr>";
	echo "<td>" .$row['id']."</td>";
	echo "<td>" .$row['username']."</td>";
	echo "<td>" .$row['solved_problems']."</td>";
	echo "<td>" .$row['score']."</td>";
	echo "<td>" .$row['total_submissions']."</td>";
	echo "<td>" .$row['correct_submissions']."</td>";
echo "</tr>";
